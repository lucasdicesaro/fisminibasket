		...
		<display:table name="sessionScope.permisos" pagesize="60" defaultorder="ascending" class="displaytag"
			...
			<%
				...
				while(it.hasNext())
				{
					...
					if(rolPermiso.getId().getPermiso().getPerDescripcion().equals("Modificar Permiso"))
					{
			%>
			...
			<%
					...
					if(rolPermiso.getId().getPermiso().getPerDescripcion().equals("Borrar Permiso"))
					{
			...
			<%
				...
				{
					rolPermiso = (RolPermiso)it.next();
					if(rolPermiso.getId().getPermiso().getPerDescripcion().equals("Insertar Permiso"))
					{
			%>
	<tr>
		<td colspan="2" align="center">
			<form action="../permiso.do" method="POST">
