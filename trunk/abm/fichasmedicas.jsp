		...
		<display:table name="sessionScope.fichasMedicas" pagesize="60" defaultorder="ascending" class="displaytag"
			...
			<%
				...
				while(it.hasNext())
				{
					...
					if(rolPermiso.getId().getPermiso().getPerDescripcion().equals("Modificar FichaMedica"))
					{
			%>
			...
			<%
					...
					if(rolPermiso.getId().getPermiso().getPerDescripcion().equals("Borrar FichaMedica"))
					{
			...
			<%
				...
				{
					rolPermiso = (RolPermiso)it.next();
					if(rolPermiso.getId().getPermiso().getPerDescripcion().equals("Insertar FichaMedica"))
					{
			%>
	<tr>
