		...
		<display:table name="sessionScope.medicos" pagesize="60" defaultorder="ascending" class="displaytag"
			...
			<%
				...
				while(it.hasNext())
				{
					...
					if(rolPermiso.getId().getPermiso().getPerDescripcion().equals("Modificar Medico"))
					{
			%>
			...
			<%
					...
					if(rolPermiso.getId().getPermiso().getPerDescripcion().equals("Borrar Medico"))
					{
			...
			<%
				...
				{
					rolPermiso = (RolPermiso)it.next();
					if(rolPermiso.getId().getPermiso().getPerDescripcion().equals("Insertar Medico"))
					{
			%>
	<tr>
		<td colspan="2" align="center">
			<form action="../medico.do" method="POST">
