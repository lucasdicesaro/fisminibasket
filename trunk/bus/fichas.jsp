...
<head>
<title>Fichas Medicas Faltantes</title>
<html:base />
...
<fieldset><legend>Fichas Medicas Faltantes</legend>

<table align="center" width="90%">

	<tr>
		<td>
		<display:table name="sessionScope.fichasFaltantes" pagesize="60" defaultorder="ascending" class="displaytag"
			...
			<display:column title="Crear Ficha"  href="../fichamedica.do?action=setInsert"  paramId="jugador" paramProperty="jugId" media="html">
